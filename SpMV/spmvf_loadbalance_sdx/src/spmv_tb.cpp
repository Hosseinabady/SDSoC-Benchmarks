...
//	uintbuswidth_t *x            = NULL;
	...
	printf("rows_1_size=%d, rows_2_size=%d, rows_3_size=%d, rows_4_size=%d, rows_5_size=%d, rows_6_size=%d, rows_7_size=%d, rows_8_size=%d \n",
			rows_1_size,    rows_2_size,    rows_3_size,    rows_4_size,    rows_5_size,    rows_6_size,    rows_7_size,    rows_8_size );

	printf("values_1_size=%d, values_2_size=%d, values_3_size=%d, values_4_size=%d, values_5_size=%d, values_6_size=%d, values_7_size=%d, values_8_size=%d \n ",
			values_1_size,    values_2_size,    values_3_size,    values_4_size,    values_5_size,    values_6_size,    values_7_size,    values_8_size    );

	printf("compact_indices_size = %d\n", compact_indices_size);




	int effective_row = rows_1_size+rows_2_size;
	if (effective_row < rows_3_size+rows_4_size)
		effective_row = rows_3_size+rows_4_size;
	if (effective_row < rows_5_size+rows_6_size)
		effective_row = rows_5_size+rows_6_size;
	if (effective_row < rows_7_size+rows_8_size)
		effective_row = rows_7_size+rows_8_size;
	printf("effective_row = %d\n", effective_row);

	int effective_value = values_1_size+rows_1_size*II;
	if (effective_value < values_2_size+rows_2_size*II)
		effective_value = values_2_size+rows_2_size*II;
	if (effective_value < values_3_size+rows_3_size*II)
		effective_value = values_3_size+rows_3_size*II;
	if (effective_value < values_4_size+rows_4_size*II)
		effective_value = values_4_size+rows_4_size*II;
	if (effective_value < values_5_size+rows_5_size*II)
		effective_value = values_5_size+rows_5_size*II;
	if (effective_value < values_6_size+rows_6_size*II)
		effective_value = values_6_size+rows_6_size*II;
	if (effective_value < values_7_size+rows_7_size*II)
		effective_value = values_7_size+rows_7_size*II;
	if (effective_value < values_8_size+rows_8_size*II)
		effective_value = values_8_size+rows_8_size*II;


	printf("effective_value = %d\n", effective_value);
