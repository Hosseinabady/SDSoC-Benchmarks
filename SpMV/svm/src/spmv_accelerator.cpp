...
#pragma HLS ARRAY_PARTITION variable=term_1 complete dim=1
	...
	col_left_1 = 0;
	for (r = 0; r < values_1_size-row_1_size+row_1_size*II; r+=II) {
#pragma HLS PIPELINE
...
#pragma HLS ARRAY_PARTITION variable=term_2 complete dim=1
	...
	for (r = 0; r < values_2_size-row_2_size+row_2_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_2 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=term_3 complete dim=1
	...
	col_left_3 = 0;
	for (r = 0; r < values_3_size-row_3_size+row_3_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_3 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=term_4 complete dim=1
	...
	col_left_4 = 0;
	for (r = 0; r < values_4_size-row_4_size+row_4_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_4 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=term_5 complete dim=1
	...
	col_left_5 = 0;
	for (r = 0; r < values_5_size-row_5_size+row_5_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_5 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=term_6 complete dim=1
	...
	col_left_6 = 0;
	for (r = 0; r < values_6_size-row_6_size+row_6_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_6 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=term_7 complete dim=1
	...
	col_left_7 = 0;
	for (r = 0; r < values_7_size-row_7_size+row_7_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_7 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=term_8 complete dim=1
	...
	col_left_8 = 0;
	for (r = 0; r < values_8_size-row_8_size+row_8_size*II; r+=II) {
#pragma HLS PIPELINE
		if (col_left_8 == 0) {
...
#pragma HLS ARRAY_PARTITION variable=x_8_local cyclic factor=2 dim=1
	...
	for (u32 i = 0; i < col_size/4+1; i+=1) {
#pragma HLS PIPELINE
